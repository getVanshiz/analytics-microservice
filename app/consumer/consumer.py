...
from app.tracing import extract_trace
# ⬆⬆⬆
...
from app.logging_config import setup_logging   # ⬅ added

setup_logging()
log = logging.getLogger("analytics-consumer")

tracer = trace.get_tracer("analytics-consumer")  # ⬅ added
...
def start_consumer():
    ...
    while True:
        try:
            ...
            log.exception("Error processing message, retrying...")
            time.sleep(0.2)